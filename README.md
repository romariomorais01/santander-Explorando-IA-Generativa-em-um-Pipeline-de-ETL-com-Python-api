...
👉 Esse README agora cobre **execução local, endpoints, exemplos de requisição e deploy**.  
Quer que eu adicione também uma seção de **Deploy no Railway passo a passo** (com `Procfile` e comandos) para que você consiga colocar sua API online facilmente?
